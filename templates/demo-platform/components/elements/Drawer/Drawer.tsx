...
import {IconClose, IconWarning} from '~/components/elements/Icons'
...
function Alert({
  ...
  return (
    <div className="absolute left-0 right-0 top-0 z-20 flex min-h-[60px] items-center justify-center bg-error-alert px-unit-4">
      <div className="flex justify-center gap-unit pr-unit-8 align-middle">
    ...
    <DrawerContext.Provider value={drawerContextProviderValue}>
      ...
      {mounted && (
        <Portal.Root>
          ...
          >
            {alert && (
              <Alert message={alert} onCloseHandler={() => setAlert(null)} />
            )}
            {/* @ts-ignore */}
